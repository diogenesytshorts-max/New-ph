...
echo -e "\033[0;34m   ✨ FIXING TYPO & BUILDING #PH-LIVE-200 LIVE                  \033[0m"
echo -e "\033[0;34m================================================================\033[0m\n"

# 2. Fix web_challan_stitcher_wizard.dart (Fixed .any() bool typo)
echo -e "\033[1;33m[1/4] Fixing bool.any() in web_challan_stitcher_wizard.dart...\033[0m"
cat << 'STITCHER_FIXED_EOF' > lib/web_live_sync/web_challan_stitcher_wizard.dart
...
# 3. Verify Strict 0-Issue Static Analyzer
echo -e "\033[1;33m[2/4] Verifying 0 Issues with Flutter Analyzer...\033[0m"
...
git add .
git commit -m "Fix Typo & Deploy 4-Button Challans Hub Live (#PH-LIVE-200)" || true
git push origin main || true

echo -e "\n\033[0;34m================================================================\033[0m"
echo -e "\033[0;32m  🎉 100% CLEAN DEPLOYED! #PH-LIVE-200 IS LIVE!\033[0m"
