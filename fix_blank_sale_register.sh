...
echo -e "${BLUE}====================================================${NC}"
echo -e "${BLUE}   🚀 FIXING LAYOUT & DEPLOYING #PH-REV-125        ${NC}"
echo -e "${BLUE}====================================================${NC}\n"

# 1. Update Top Bar Badge to #PH-REV-125
echo -e "${YELLOW}[1/3] Updating Top Bar Badge to #PH-REV-125...${NC}"
...
# 2. Fix WebSaleSummaryView layout by removing invalid Expanded
echo -e "${YELLOW}[2/3] Fixing WebSaleSummaryView render layout...${NC}"
...
# 3. Build & Direct Deploy
echo -e "${YELLOW}[3/3] Compiling Web Workstation (#PH-REV-125)...${NC}"
...
git add .
git commit -m "Fix Sale Register Layout Crash & Deploy #PH-REV-125" || true
git push origin main || true

echo -e "\n${BLUE}====================================================${NC}"
echo -e "${GREEN}  🎉 DEPLOY COMPLETE: #PH-REV-125 LIVE!${NC}"
echo -e "${BLUE}====================================================${NC}"
