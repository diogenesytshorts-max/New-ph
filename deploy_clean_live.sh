...
echo -e "\033[0;34m   ✨ CLEANING WARNINGS & BUILDING LIVE WEB        \033[0m"
echo -e "\033[0;34m====================================================\033[0m\n"

# 2. Fix web_portal_gateway.dart (Remove unused import)
echo -e "\033[1;33m[1/4] Fixing web_portal_gateway.dart...\033[0m"
cat << 'GATEWAY_FIX_EOF' > lib/web_live_sync/web_portal_gateway.dart
...
# 3. Fix web_returns_view.dart (Clean unnecessary casts)
echo -e "\033[1;33m[2/4] Fixing web_returns_view.dart...\033[0m"
cat << 'RETURNS_FIX_EOF' > lib/web_live_sync/web_returns_view.dart
...
# 4. Strict Zero-Issue Analyzer Check
...
git add .
git commit -m "Zero Warnings Clean Deploy Live" || true
git push origin main || true

echo -e "\n\033[0;34m====================================================\033[0m"
echo -e "\033[0;32m  🎉 100% CLEAN DEPLOYED LIVE SUCCESSFULLY!\033[0m"
