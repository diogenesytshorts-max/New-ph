...
# 1. Environment & Token Setup (Permanent Token)
...
echo -e "\033[0;34m   🚀 DEPLOYING 4-BUTTON CHALLANS HUB (#PH-LIVE-200)             \033[0m"
echo -e "\033[0;34m================================================================\033[0m\n"

# 2. Update web_top_bar.dart with #PH-LIVE-200
...
# 3. Update web_modules_registry.dart with 4 Exact App Actions
...
# 4. Write WebChallanView (4 Exact App Cards + Full Sub-Views)
...
# 5. Clean RAM, Verify Analyzer (0 Warnings) and Fast Deploy Live
echo -e "\033[1;33m[4/5] Running strict zero-warning analyzer check...\033[0m"
pkill -f "analysis_server" 2>/dev/null || true
flutter analyze lib/web_live_sync/

echo -e "\033[1;33m[5/5] Compiling & Deploying Web Workstation to Production...\033[0m"
sync
...
git add .
git commit -m "Deploy 4-Button Challans Hub (App Parity) #PH-LIVE-200" || true
git push origin main || true

echo -e "\n\033[0;34m================================================================\033[0m"
echo -e "\033[0;32m  🎉 4-BUTTON CHALLANS HUB IS LIVE! (#PH-LIVE-200)\033[0m"
